            ...
            <main className="flex-grow">
                ...
                <section className="relative -mt-20 px-4">
                    <div
                        ...
                        <Link
                            href="/shop"
                            className="inline-block mt-6 px-8 py-3 bg-[#D4A76A] text-white rounded-md font-medium shadow-md hover:opacity-90 transition"
                        >
                            Shop now
                        </Link>
                    </div>
                    ...
                    <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 text-center gap-10 md:gap-6">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center text-center">
                                ...
                                />
                                <p className="text-[#2E4A35] font-medium text-lg">{stat.label}</p>
                                <p className="text-[#2E4A35] font-bold text-xl mt-1">{stat.value}</p>
                            </div>
                        ))}
                    </div>
                </section>
